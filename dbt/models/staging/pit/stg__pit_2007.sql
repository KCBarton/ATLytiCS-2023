/*
a MO-604 covers territory in both Missouri and Kansas. 
The record described in this file represents the CoC's total territory, 
...
SELECT *
FROM {{ source('point_in_time', 'seed__2007_pit_counts_by_coc') }}